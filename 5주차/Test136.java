...
public class Test135
{
	public static void main(String[] args)
	{
		...
		System.out.println("3 : " +(3.0/0 == 3.0/0));	// (Infinity == Infinity) 크기비교
		System.out.println("4 : " +(3.0/0 == -3.0/0));
		//--==>> 3 : true								// 자바에서는 무한대와 무한대 크기비교 가능
		//		 4 : false
		...
		//--==>> 7 : NaN (→ Not a Number : 숫자가 아니다라는 결과)
		//		 8 : NaN

		System.out.println("9 : " +(0.0/0 == 0.0/0));	// (NaN == NaN) 크기비교
